# Meeple Import Doctor (`boardgame-catalog-import-debugger`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://boardgame-catalog-import-debugger.sociobot.in`. Artifact class: `static-web`.
